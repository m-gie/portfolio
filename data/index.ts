...
export const gridItems = [
    {
        id: 1,
        title: "I'm dedicated to meeting client needs through open collaboration.",
        description: "",
    ...
    {
        id: 5,
        title: "Currently building a LiveDocs application",
    ...
    {
        id: 6,
        title: "I'm seeking new opportunities to contribute my skills",
        description: "",
        className: "lg:col-span-2 md:col-span-3 md:row-span-1",
        imgClassName: "",
...
export const workExperience = [
    {
        id: 1,
        title: "CSA at Amazon",
        desc: "Addressed the customers queries.",
